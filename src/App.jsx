    ...
    <section id="contact" className="pb-24 lg:pb-28">
      <Container>
        ...
        >
          ...
          />
          <div className="relative">
            <h2 className="wt-title1" style={{ color: "#fff", textWrap: "balance" }}>
  ...
  return (
    <footer style={{ borderTop: "1px solid var(--wt-border)" }}>
      ...
      <Container className="flex flex-col items-center justify-between gap-3 py-6 md:flex-row">
        <span className="wt-caption1" style={{ color: "var(--wt-text-assistive)" }}>
          © 2026 FLOFIL Inc. All rights reserved.
        </span>
        <span className="wt-caption1" style={{ color: "var(--wt-text-assistive)" }}>
          서울특별시 · contact@flofil.co.kr
        </span>
      </Container>
    </footer>
  );
